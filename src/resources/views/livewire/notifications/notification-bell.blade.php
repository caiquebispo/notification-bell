<div 
    ...
    showToast(data) {
        ...
        @if(config('notifications.features.sound.enabled', false))
            try {
                const vol = {{ config('notifications.features.sound.volume', 0.5) }};
                ...
                if (AudioCtx) {
                    ...
                    if (type === 'success') {
                        ...
                        gain1.gain.setValueAtTime(vol * 0.4, ctx.currentTime);
                        ...
                        gain2.gain.setValueAtTime(vol * 0.4, ctx.currentTime + 0.12);
                        ...
                        const gain2 = ctx.createGain();
                        osc2.type = 'triangle';
                        osc2.frequency.setValueAtTime(261.63, ctx.currentTime + 0.15);
                        gain2.gain.setValueAtTime(0.001, ctx.currentTime);
                        ...
                        gain1.gain.setValueAtTime(vol * 0.15, ctx.currentTime);
                        ...
                        gain2.gain.setValueAtTime(0.001, ctx.currentTime);
                        gain2.gain.setValueAtTime(vol * 0.15, ctx.currentTime + 0.18);
